...
class EmployerName extends StatefulWidget {
 final String title;
  const EmployerName({required this.title,Key? key}) : super(key: key);

  @override
  State<EmployerName> createState() => _EmployerNameState();
}

class _EmployerNameState extends State<EmployerName> {
                    ...
                    onTap: (_) {
                      if (key.currentState!.validate()) {
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) => const ProjectTitle(title: 'Project Title',)));
                      }
                    },
                  ),
                ),
