...
import 'package:fyp/screens/handyman/component/work_to_be_completed.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            TitleWithTextField(
                ...
                title: 'e.g fence Repair',
                text: 'Give this Project a Title',
                    ...
                    onTap: (_) {
                      if (key.currentState!.validate()) {
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) => const WorkToBeCompleted(title: 'Work To Be Completed')));
                      }
                    },
                  ),
                ),
