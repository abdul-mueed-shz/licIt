...
class RentalProvider with ChangeNotifier {
  DateTime selectedStartDateTemplate = DateTime.now();
  bool isDraft = false;
  bool isShow = false;
  ContractModel? myModel;
  ...
  void getDataFromPref() async {
    final rentalData = storage.contract;
    rentalAgreementLocation.text = rentalData?.rentalAgreementLocation ?? '';
    rentalAgreementDate.text = rentalData?.rentalAgreementDate ?? '';
    rentalAgreementUserNameFrom.text =
        rentalData?.rentalAgreementUserNameFrom ?? '';
    rentalAgreementGender.text = rentalData?.rentalAgreementGender ?? '';
    rentalAgreementAge.text = rentalData?.rentalAgreementAge ?? '';
    rentalAgreementResiding.text = rentalData?.rentalAgreementResiding ?? '';
    rentalAgreementUserAddressFrom.text =
        rentalData?.rentalAgreementUserAddressFrom ?? '';
    rentalAgreementUserCityFrom.text =
        rentalData?.rentalAgreementUserCityFrom ?? '';
    rentalAgreementUserAreaCodeFrom.text =
        rentalData?.rentalAgreementUserAreaCodeFrom ?? '';
    rentalAgreementUserCountryFrom.text =
        rentalData?.rentalAgreementUserCountryFrom ?? '';
    rentalAgreementUserCnicFrom.text =
        rentalData?.rentalAgreementUserCnicFrom ?? '';
    rentalAgreementUserNameTO.text =
        rentalData?.rentalAgreementUserNameTO ?? '';
    rentalAgreementUserGender.text =
        rentalData?.rentalAgreementUserGender ?? '';
    rentalAgreementUserAgeTo.text = rentalData?.rentalAgreementUserAgeTo ?? '';
    rentalAgreementUserResidingTo.text =
        rentalData?.rentalAgreementUserResidingTo ?? '';
    rentalAgreementUserAddressTo.text =
        rentalData?.rentalAgreementUserAddressTo ?? '';
    rentalAgreementUserCityTo.text =
        rentalData?.rentalAgreementUserCityTo ?? '';
    rentalAgreementUserAreaCodeTo.text =
        rentalData?.rentalAgreementUserAreaCodeTo ?? '';
    rentalAgreementUserCountryTo.text =
        rentalData?.rentalAgreementUserCountryTo ?? '';
    rentalAgreementUserCnicTo.text =
        rentalData?.rentalAgreementUserCnicTo ?? '';
    rentalAgreementUserHouse.text = rentalData?.rentalAgreementUserHouse ?? '';
    rentalAgreementUserHouseBlock.text =
        rentalData?.rentalAgreementUserHouseBlock ?? '';
    rentalAgreementUserHouseAddress.text =
        rentalData?.rentalAgreementUserHouseAddress ?? '';
    rentalAgreementUserHouseCity.text =
        rentalData?.rentalAgreementUserHouseCity ?? '';
    rentalAgreementUserHouseAreaCode.text =
        rentalData?.rentalAgreementUserHouseAreaCode ?? '';
    rentalAgreementUserHouseCountry.text =
        rentalData?.rentalAgreementUserHouseCountry ?? '';
    rentalAgreementUserHouseBedroom.text =
        rentalData?.rentalAgreementUserHouseBedroom ?? '';
    rentalAgreementUserHouseBathroom.text =
        rentalData?.rentalAgreementUserHouseBathroom ?? '';
    rentalAgreementUserHouseBalconey.text =
        rentalData?.rentalAgreementUserHouseBalconey ?? '';
    rentalAgreementUserHouseCarPorch.text =
        rentalData?.rentalAgreementUserHouseCarPorch ?? '';
    rentalAgreementUserHousekitchen.text =
        rentalData?.rentalAgreementUserHousekitchen ?? '';
    rentalAgreementUserHouseAnyFitting.text =
        rentalData?.rentalAgreementUserHouseAnyFitting ?? '';
  }
  ...
  void updateGeneralTextField() async {
    ...
    if (contract?.id == null) {
      ...
      await contractRepository.add(modal);
      await setContractPref(modal);
      EasyLoading.dismiss();
      return;
    }
