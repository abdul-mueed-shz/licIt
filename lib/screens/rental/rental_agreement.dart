...
import 'package:fyp/screens/rental/component/rental_category.dart';
...
class RentAgreement extends StatelessWidget {
  static const String routeName = '/rentalAgreement';
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          RadioListWidget(
              selectedRadioValue: provider.onChangedRentalPaymentRadioValue,
              title: 'Are you Renter ?',
              delay: 300,
  ...
  void _tap(BuildContext context) async {
    ...
    if (provider.selectedRentalRadioValue == null) {
      return EasyLoading.showError("Please Fill All Field");
    }

    Navigator.push(
        context, MaterialPageRoute(builder: (_) => const RentCategory()));
  }
